...
import {logoDark, cart, logged} from '../assets';


const Header = () => {
  return (
    <div className='w-full h-20 bg-white border-b-[1px]
     border-b-gray-800 font-titleFont sticky'>
        ...
        h-full mx-auto flex items-center justify-between'>
             ...
             <div className='flex items-center gap-8'>
                <ul className='flex items-center gap-8 '>
                  <li className='text-base text-black font-bold
                ...
                <div className='relative'>
                   ...
                   flex items-center justify-center font-semibold'>0</span>
                </div>
